...
export const CURRENT_ANALYSIS_SCHEMA_VERSION = ANALYSIS_SCHEMA_V3_VERSION;
...
export type AnalysisDocument = AnalysisDocumentV1 | AnalysisDocumentV2 | AnalysisDocumentV3;
...
export interface EffectiveProjectConfiguration {
  readonly source: {
    ...
    readonly fileVersion: 1 | 2 | 3 | null;
  };
  readonly analysis: {
...
export interface EndpointTraceTerminal {
  ...
  /** Present on v3 traces; omitted by frozen v1/v2 views. */
...
export interface EndpointTraceView {
  ...
  /** Present only on v3 endpoint traces. */
  readonly causalSummary?:
    | {
        ...
        /** Present when a v3 trace initiates a queue or microservice boundary. */
