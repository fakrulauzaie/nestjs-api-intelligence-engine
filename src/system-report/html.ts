...
<div class="workspace"><section class="card"><div id="graph" aria-hidden="true"></div></section><aside id="inspector" class="card inspector" aria-live="polite"><h3>Inspect the graph</h3><p class="muted">Select a correlation, node, or edge.</p></aside></div>
