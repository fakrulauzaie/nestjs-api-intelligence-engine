...
#graph { position: relative; width: 100%; min-height: 35rem; }
...
code { color: #b9d8ff; }
@media (max-width: 900px) { .layout, .workspace { grid-template-columns: 1fr; } .sidebar { border-right: 0; border-bottom: 1px solid #29405f; } #graph { min-height: 28rem; } }
`;
