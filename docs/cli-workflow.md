...
Resource-access nodes show structural targets and causal class, and participate in
supported-root reach without being reclassified as communication interactions.
